...
Due: Sunday 12/06/15 by 11:59pm 
...
• 50% Technical Quality: 
	o 30% - System performs correctly: asks the user the correct questions, knows when to stop searching, and reaches the correct conclusion.
	o 10% - Completeness and accuracy of the knowledge base in the system. 
	o 10% - Originality and usefulness of your expert system.  
• 25% Documentation: 
	o 5% - Clean, well-organized and neat code. 
	o 3% - Clear instructions on how to run your program. 
	o 2% - Description of your expert system: what it does and how it works. Including a brief description to the user at the start program about what the expert system will do for the user. 
	o 15% - Well written, meaningful comments throughout the whole code including comments before each of the rules/objects stating what the rule/object does. 
 
• 25% Usability: User interface that is easy to use and intuitive.
	o 10% - Easy to understand questions and messages to the user. 
	o 10% - Status information showing conclusions made by the expert system as it runs. 
	o 5% - Error checking on user input. 
